...
import { LearningTrafficLight } from './LearningTrafficLight';
...
export default function App() {
  ...
  return <main>
    ...
    <LearningTrafficLight state={state} evaluation={evaluation}/>
    ...
    <ResearchAuditorPanel enabled={state.organisms.length > 0} stepCount={state.stepCount} audit={researchAudit} onBeforeAudit={() => setRunning(false)} onAudit={setResearchAudit}/>
    <ExperimentStudio audit={researchAudit} currentStateHash={state.stateHash} user={authUser} canAudit={state.organisms.length > 0} onBeforeAudit={() => setRunning(false)} onAudit={setResearchAudit}/>
